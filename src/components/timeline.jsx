...
export default class Timeline extends Component {
    render() {
        return ( <
            ...
            <
            h2 > Internship at Juniper < span > 2019 - present < /span></h
            2 >
            <
            ...
            div className = "timeline-label" >
            <
            h2 > Undergraduation at DAIICT < span > 2015 - 2019 < /span></h
            2 >
            <
            ...
            div className = "timeline-label" >
            <
            h2 > Primary and Higher Education < span > 2003 - 2015 < /span></h
            2 >
            <
